      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setSheetState) {
          ...
          final filtered = options
              ...
              .toList();
          final hasExactMatch = rawQuery.isNotEmpty &&
              options.any((item) => item.toLowerCase() == query);
                  ...
                  Flexible(
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final adjustedIndex =
                            !hasExactMatch && rawQuery.isNotEmpty
                                ? index - 1
                                : index;
                        final item = filtered[adjustedIndex];
                        final isSelected = controller.text.trim() == item;
